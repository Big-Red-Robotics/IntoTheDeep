...
public final class ThreeDeadWheelLocalizer implements Localizer {
    ...
    public ThreeDeadWheelLocalizer(HardwareMap hardwareMap, double inPerTick) {
        par0 = new OverflowEncoder(new RawEncoder(hardwareMap.get(DcMotorEx.class, "par0"))); //the left one
        par1 = new OverflowEncoder(new RawEncoder(hardwareMap.get(DcMotorEx.class, "par1"))); //the right one
        perp = new OverflowEncoder(new RawEncoder(hardwareMap.get(DcMotorEx.class, "dBL"))); //perpendicular
