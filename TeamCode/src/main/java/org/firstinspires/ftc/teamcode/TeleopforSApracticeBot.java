//Code for Selena and Alfie's starter bot teleop
...
@TeleOp(name="Isha's code for S&A: Omni Linear OpMode", group= "Linear OpMode")
public class TeleopforSApracticeBot extends LinearOpMode {

    // Declare OpMode members for each of the 4 motors and armm motor.
